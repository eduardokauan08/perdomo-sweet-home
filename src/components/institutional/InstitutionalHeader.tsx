    ...
    <header className="bg-white/95 backdrop-blur-md border-b border-gray-200/80 px-6 py-4 sticky top-0 z-50 shadow-sm">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          <div className="bg-gradient-to-br from-primary to-primary/80 text-white px-5 py-2.5 rounded-xl font-display font-extrabold text-xl shadow-lg hover:shadow-xl transition-shadow duration-300 tracking-tight">
            Perdomo
          </div>
          <div className="hidden md:block">
            <span className="text-foreground font-semibold text-lg">Doces Artesanais</span>
            <div className="text-xs text-foreground/70 font-medium">10 anos adoçando sua vida</div>
          </div>
        </div>
